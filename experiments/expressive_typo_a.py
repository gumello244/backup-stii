...
class ExpressiveTypoA(QMainWindow):
    """ExpressiveTypoA: Unified popover card featuring a gigantic Hero Stat."""

    def __init__(self) -> None:
        super().__init__()
        self.setWindowTitle("Remos — Expressive Typo A")
    ...
    def _setup_state_selector(self, parent_layout: QVBoxLayout) -> None:
        ...
        title = QLabel("Hero Typo A — Estado do Teste:")
    ...
    def _setup_card_header(self, layout: QVBoxLayout) -> None:
        ...
        self._subtitle = QLabel("Processando informações dos arquivos de backup.")
    ...
    def _update_ui_state(self, state_id: int) -> None:
        ...
        if state_id == 0:
            self._show_loading("Pesquisando caminhos de backup salvos...")
        elif state_id == 1:
            self._show_loading("Calculando integridade das versões...")
        elif state_id == 2:
            self._show_error()
        elif state_id == 3:
            self._show_resolved()
    ...
    def _show_resolved(self) -> None:
        ...
        hero = QLabel("2.3 GB")
        hero.setObjectName("HeroNumber")
        hero.setAlignment(Qt.AlignCenter)

        sub = QLabel("9 arquivos prontos em 3 pastas")
        sub.setObjectName("HeroSub")
        sub.setAlignment(Qt.AlignCenter)

        details = QLabel("Backup mais recente gerado em 24/06/2026")
        details.setObjectName("MutedDetails")
