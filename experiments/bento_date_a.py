...
class BentoDateA(QMainWindow):
    """BentoDateA: Asymmetric bento grid highlighting the backup date on the left."""

    def __init__(self) -> None:
        super().__init__()
        self.setWindowTitle("Remos — Bento Date A")
    ...
    def _setup_state_selector(self, parent_layout: QVBoxLayout) -> None:
        ...
        title = QLabel("Bento Date A — Estado do Teste:")
    ...
    def _show_resolved(self) -> None:
        ...
        # Bento 1: Hero Date (Spans 2 rows)
