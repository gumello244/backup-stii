...
class BentoUnifiedPrototype(QMainWindow):
    """BentoUnifiedPrototype: Clean asymmetrical horizontal grid with unified loaders."""

    def __init__(self) -> None:
        super().__init__()
        self.setWindowTitle("Remos — Bento Unified Prototype")
    ...
    def _setup_state_selector(self, parent_layout: QVBoxLayout) -> None:
        ...
        title = QLabel("Unificado — Estado do Teste:")
