...
class BentoDateB(QMainWindow):
    """BentoDateB: Asymmetric bento grid highlighting the backup date in a wide top row."""

    def __init__(self) -> None:
        super().__init__()
        self.setWindowTitle("Remos — Bento Date B")
    ...
    def _setup_state_selector(self, parent_layout: QVBoxLayout) -> None:
        ...
        title = QLabel("Bento Date B — Estado do Teste:")
    ...
    def _setup_card_header(self, layout: QVBoxLayout) -> None:
        self._title = QLabel("Análise Concluída")
        self._title.setObjectName("ViewTitle")
        self._title.setAlignment(Qt.AlignCenter)
        layout.addWidget(self._title)

        self._subtitle = QLabel("Backup identificado com sucesso.")
    ...
    def _update_ui_state(self, state_id: int) -> None:
        ...
        if state_id == 0:
            self._show_loading("Verificando backups do usuário...")
        elif state_id == 1:
    ...
    def _show_resolved(self) -> None:
        ...
        # Bento 1: Top Hero Date (Spans 2 columns)
        hero = self._create_bento_box("ÚLTIMO BACKUP", "24 de Junho de 2026", "Status: backup saudável", True)
