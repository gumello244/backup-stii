...
class BentoUnifiedCenteredPrototype(QMainWindow):
    """BentoUnifiedCenteredPrototype: Center-aligned typography header/subtitles & unified loaders."""

    def __init__(self) -> None:
        super().__init__()
        self.setWindowTitle("Remos — Bento Unified Centered Prototype")
    ...
    def _setup_state_selector(self, parent_layout: QVBoxLayout) -> None:
        ...
        title = QLabel("Unificado Centrado — Estado:")
...
if __name__ == "__main__":
    ...
    window = BentoUnifiedCenteredPrototype()
    window.show()
    sys.exit(app.exec_())
